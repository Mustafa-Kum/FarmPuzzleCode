...
namespace _Game.Scripts.Managers.Core
{
    public class AnalyticsManager : MonoBehaviour
    {
        ...
        {
            EventManager.LevelEvents.GameStarted += LogGameStart;
            EventManager.LevelEvents.LevelStart += LogLevelStart;
            EventManager.LevelEvents.LevelSuccess += LogLevelSuccess;
            EventManager.LevelEvents.LevelFail += LogLevelFail;
            EventManager.SaveEvents.DataLoaded += LogDataLoaded;
            EventManager.LevelEvents.LevelLoaded += LogLevelLoaded;
        ...
        private void LogLevelSuccess()
        {
            ...
            LogEvent($"Levels:Level{playerSavableData.LevelIndex}:LevelSuccess", analyticData);
        }
