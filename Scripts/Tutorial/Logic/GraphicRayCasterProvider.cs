...
namespace _Game.Scripts.Tutorial.Logic
{
    public class GraphicRayCasterProvider : MonoBehaviour
    {
        ...
        private void OnEnable() => EventManager.LevelEvents.LevelStart += SendGraphicRayCaster;

        private void OnDisable() => EventManager.LevelEvents.LevelStart -= SendGraphicRayCaster;
