...
namespace _Game.Scripts.Tutorial.Logic
{
    ...
    public class TutorialManager : MonoBehaviour
    {
        ...
        {
            EventManager.LevelEvents.LevelSuccess += ClearBoosterButtonListCache;
            EventManager.LevelEvents.LevelSuccess += ResetCurrentStepIndex;
            EventManager.LevelEvents.LevelFail += ResetCurrentStepIndex;
            EventManager.LevelEvents.LevelFail += ClearBoosterButtonListCache;
