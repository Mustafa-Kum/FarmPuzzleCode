...
namespace _Game.Scripts.Template.GlobalProviders.Input
{
    public abstract class InputProvider : MonoBehaviour
    {
        ...
        {
            EventManager.LevelEvents.LevelStart += StartClickableEvents;
            EventManager.LevelEvents.LevelSuccess += StopClickableEvents;
            EventManager.LevelEvents.LevelFail += StopClickableEvents;
