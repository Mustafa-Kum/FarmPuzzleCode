...
namespace _Game.Scripts.Template.GlobalProviders.Input
{
    public class ClickableObject : MonoBehaviour, IClickable
    {
        ...
        {
            EventManager.LevelEvents.LevelSuccess += DisableClickAction;
            EventManager.LevelEvents.LevelFail += DisableClickAction;
            EventManager.LevelEvents.LevelStart += EnableClickAction;
